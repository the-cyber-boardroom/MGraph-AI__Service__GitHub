...
[![Current Release](https://img.shields.io/badge/release-v0.6.10-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__GitHub/releases)
...
[![CI Pipeline - DEV](https://github.com/the-cyber-boardroom/MGraph-AI__Service__GitHub/actions/workflows/ci-pipeline__dev.yml/badge.svg)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__GitHub/actions)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__GitHub](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# or
uvicorn mgraph_ai_service_github.fast_api.lambda_handler:app --reload --host 0.0.0.0 --port 10011
```
...
# Run with coverage
pytest --cov=mgraph_ai_service_github
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__GitHub/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__GitHub/discussions)
