...
from mgraph_ai_service_github.schemas.github.Safe_Str__GitHub__Repo_Name import Safe_Str__GitHub__Repo_Name, TYPE_SAFE_STR__GITHUB__REPO_NAME__MAX_LENGTH
