...
from mgraph_ai_service_github.config                                 import LAMBDA_DEPENDENCIES__SERVICE__GITHUB
from mgraph_ai_service_github.utils.Version                          import version__mgraph_ai_service_github
from mgraph_ai_service_github.utils.deploy.Deploy__Service           import Deploy__Service
...
class test_Deploy__Service__base():     # Base class for deployment tests - override stage in subclasses
    ...
    def test_2__upload_dependencies(self):
        ...
        assert list_set(upload_results) == LAMBDA_DEPENDENCIES__SERVICE__GITHUB
    ...
    def test_5__invoke__function_url(self):
        version = {'version': version__mgraph_ai_service_github}
