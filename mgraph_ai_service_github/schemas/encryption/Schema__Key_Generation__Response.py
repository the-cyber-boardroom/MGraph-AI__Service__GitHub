...
class Schema__Key_Generation__Response(Type_Safe):                                   # Schema for key generation response
    success     : bool                                    = False
    public_key  : Optional[Safe_Str__NaCl__Public_Key  ]  = None                      # Public key (hex)
    private_key : Optional[Safe_Str__NaCl__Private_Key ]  = None                      # Private key (hex) - only in generation
