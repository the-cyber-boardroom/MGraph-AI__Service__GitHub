...
class Schema__GitHub__Data__Request__Secret__Update(Schema__Request__Data):     # Request data for updating a repository secret
    owner          : Safe_Str__GitHub__Repo_Owner                               # Repository owner
    repo           : Safe_Str__GitHub__Repo_Name                                # Repository name
    secret_name    : Safe_Str__GitHub__Secret_Name                              # Name of the secret to update
    encrypted_value: Safe_Str__Encrypted_Value                                  # New secret value encrypted with server's public key
