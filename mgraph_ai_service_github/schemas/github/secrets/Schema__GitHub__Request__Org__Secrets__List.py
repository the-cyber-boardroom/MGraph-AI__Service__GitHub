...
class Schema__GitHub__Request__Org__Secrets__List(Schema__GitHub__Request__Base): # Request schema for listing organization secrets
    request_data: Schema__GitHub__Data__Request__Org__Secrets__List             # Organization name
