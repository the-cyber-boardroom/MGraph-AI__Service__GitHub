...
class Schema__GitHub__Data__Request__Org__Secret__Get(Schema__Request__Data):   # Request data for getting an org secret
    org        : Safe_Str__GitHub__Repo_Owner                                   # Organization name
    secret_name: Safe_Str__GitHub__Secret_Name                                  # Name of the secret
