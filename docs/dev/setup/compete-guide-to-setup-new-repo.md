...
git fetch template
git merge template/main --allow-unrelated-histories -m "Initial import from MGraph-AI__Service__GitHub template"
```
...
mv mgraph_ai_service_github mgraph_ai_service_graphs
```
...
1. **Replace "MGraph-AI Service GitHub"** → **"MGraph-AI Service Graphs"**
   - Should find ~10 occurrences
   - These are in documentation and comments

2. **Replace "mgraph_ai_service_github"** → **"mgraph_ai_service_graphs"**
   - Should find 1-2 occurrences (after rename script)
   - This is the Python package name

3. **Replace "MGraph-AI__Service__GitHub"** → **"MGraph-AI__Service__Graphs"**
...
- Based on MGraph-AI__Service__GitHub v0.3.0
